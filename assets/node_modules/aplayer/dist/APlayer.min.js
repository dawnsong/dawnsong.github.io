                          ...
                          [
                              {
                                  ...
                                  value: function () {
                                      var e = this
                                      ;(this.audio = document.createElement('audio')), (this.audio.id=this.options.id4audio), (this.audio.preload = this.options.preload), (this.audio.crossorigin="anonymous"), (document.body.appendChild(this.audio))
                                      for (
                                          var t = function (t) {
                              ...
                              },
                              {
                                  ...
                                  value: function () {
                                      ...
                                      t &&
                                          t.catch(function (t) {
                                              console.warn(t), e.skipForward(), setTimeout(function (){e.play();}, 5*1000), console.log('skipForward & play after 5 seconds') //'NotAllowedError' === t.name && e.setUIPaused()
                                          })
                                  },
                              },
                              {
