                          ...
                          [
                              {
                                  ...
                                  value: function () {
                                      var e = this
                                      ;(this.audio = document.createElement('audio')), (this.audio.id=this.options.id4audio), (this.audio.preload = this.options.preload), (document.body.appendChild(this.audio))
                                      for (
                                          var t = function (t) {
